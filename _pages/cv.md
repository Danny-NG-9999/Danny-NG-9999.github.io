...
|---------------|------------------|---------------|---------------|
| Transaction Advisory Analyst | Grant Thornton | Vietnam | Nov 2022 – Jul 2024 |

| **Responsibility Area** | **Key Contributions and Achievements** |
|--------------------------|----------------------------------------|
| **Financial Due Diligence** | • Reviewed trial balances, ledgers, and financials for M&A deals (£500k–£8m).<br>• Adjusted non-recurring items and related-party transactions to normalize earnings.<br>• Identified £500k EBITDA adjustment for an FMCG client, strengthening buyer’s negotiation position. |
